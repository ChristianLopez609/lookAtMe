...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md">
                <div class="panel">
                    <div class="table-items" style="border: solid;">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>Mark</td>
                                    <td><a href="//www.youtube.com/watch?v=37IN_PW5U8E">publicidad 1</a></td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
                                    <td>Jacob</td>
                    ...
                    <div class="form-panel" style="border:solid; padding: 10px">
                        <form action="">
                            <div class="title">
